...
const bundle = fs.readFileSync(path.join(publishDirectory, 'main.v072.js'), 'utf8');
const version = '0.7.2';
const build = '20260815.05';
...
assert.deepEqual(
  ...
  ['./vendor/phaser.min.js?v=20260815-05', './main.v072.js?v=20260815-05']
);
