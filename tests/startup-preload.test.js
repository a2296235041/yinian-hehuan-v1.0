...
const gameScenePreload = read('publish/src/assets/GameScenePreload.v064.js');
const npcCards = read('publish/src/ui/NpcCardRenderer.js');
const main = read('publish/src/boot/GameBootstrap.v064.js');
...
assert.ok(characterCreation.includes('schedulePortraitWarmup'));
