...
Game.Scenes.BattleScene = class BattleScene extends Phaser.Scene {
    ...
    create() {
        ...
        const playerView = Game.BattleUI.createFighter(
            this, 360, '你', Game.PlayerPortraitAssets.textureKey(Game.player?.origin), true,
    ...
    async act(type) {
        ...
        this.logText.setText(Game.TextBoxUtils.fit(window.GameTrafficSaver.isEnabled('battle') ? state.log : `${state.log}\n\nAI 正在补全这一幕…`, 36, 4));
