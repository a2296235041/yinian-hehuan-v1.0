(function installGameScenePreload(root) {
  ...
  SceneClass.prototype.preload = function preloadGameSceneAssets() {
    ...
    const resources = [
      ...
      ['json', 'npcs', './assets/data/npcs.v025.json?v=20260804-21'],
      ['json', 'tournament_npcs', './assets/data/tournament_npcs.json?v=20260804-21'],
      ['json', 'npc_openings', './assets/data/npc_openings.v025.json?v=20260804-21'],
      ['json', 'items', './assets/data/items.json?v=20260804-21'],
      ['json', 'exploration_regions', './assets/data/exploration_regions.json?v=20260804-21'],
      ['json', 'enemies', './assets/data/enemies.json?v=20260804-21']
    ];
