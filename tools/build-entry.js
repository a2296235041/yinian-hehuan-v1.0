...
const manifestPath = path.join(__dirname, 'entry-sources.v038.json');
const outputPath = path.join(root, 'publish/main.v038.js');
...
fs.writeFileSync(outputPath, `/* release 0.3.8 sources:${digest} */\n${bundle}\n`);
