...
const manifestPath = path.join(__dirname, 'entry-sources.v039.json');
const outputPath = path.join(root, 'publish/main.v039.js');
...
fs.writeFileSync(outputPath, `/* release 0.3.9 sources:${digest} */\n${bundle}\n`);
