...
const manifestPath = path.join(__dirname, 'entry-sources.v047.json');
const outputPath = path.join(root, 'publish/main.v047.js');
...
fs.writeFileSync(outputPath, `/* release 0.4.7 sources:${digest} */\n${bundle}\n`);
