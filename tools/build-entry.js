...
const manifestPath = path.join(__dirname, 'entry-sources.v048.json');
const outputPath = path.join(root, 'publish/main.v048.js');
...
fs.writeFileSync(outputPath, `/* release 0.4.8 sources:${digest} */\n${bundle}\n`);
