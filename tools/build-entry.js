...
const manifestPath = path.join(__dirname, 'entry-sources.v055.json');
const outputPath = path.join(root, 'publish/main.v055.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.5 sources:${digest} */\n${bundle}\n`);
