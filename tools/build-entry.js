...
const manifestPath = path.join(__dirname, 'entry-sources.v046.json');
const outputPath = path.join(root, 'publish/main.v046.js');
...
fs.writeFileSync(outputPath, `/* release 0.4.6 sources:${digest} */\n${bundle}\n`);
