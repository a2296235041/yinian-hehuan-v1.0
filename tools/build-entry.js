...
const manifestPath = path.join(__dirname, 'entry-sources.v057.json');
const outputPath = path.join(root, 'publish/main.v057.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.7 sources:${digest} */\n${bundle}\n`);
