...
const manifestPath = path.join(__dirname, 'entry-sources.v053.json');
const outputPath = path.join(root, 'publish/main.v053.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.3 sources:${digest} */\n${bundle}\n`);
