...
const manifestPath = path.join(__dirname, 'entry-sources.v051.json');
const outputPath = path.join(root, 'publish/main.v051.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.1 sources:${digest} */\n${bundle}\n`);
