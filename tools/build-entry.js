...
const manifestPath = path.join(__dirname, 'entry-sources.v058.json');
const outputPath = path.join(root, 'publish/main.v058.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.8 sources:${digest} */\n${bundle}\n`);
