...
const manifestPath = path.join(__dirname, 'entry-sources.v052.json');
const outputPath = path.join(root, 'publish/main.v052.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.2 sources:${digest} */\n${bundle}\n`);
