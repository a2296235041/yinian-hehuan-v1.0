...
const manifestPath = path.join(__dirname, 'entry-sources.v061.json');
const outputPath = path.join(root, 'publish/main.v061.js');
...
fs.writeFileSync(outputPath, `/* release 0.6.1 sources:${digest} */\n${bundle}\n`);
