...
const manifestPath = path.join(__dirname, 'entry-sources.v050.json');
const outputPath = path.join(root, 'publish/main.v050.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.0 sources:${digest} */\n${bundle}\n`);
