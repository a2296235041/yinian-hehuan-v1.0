...
const manifestPath = path.join(__dirname, 'entry-sources.v037.json');
const outputPath = path.join(root, 'publish/main.v037.js');
...
fs.writeFileSync(outputPath, `/* release 0.3.7 sources:${digest} */\n${bundle}\n`);
