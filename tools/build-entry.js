...
const manifestPath = path.join(__dirname, 'entry-sources.v040.json');
const outputPath = path.join(root, 'publish/main.v040.js');
...
fs.writeFileSync(outputPath, `/* release 0.4.0 sources:${digest} */\n${bundle}\n`);
