...
const manifestPath = path.join(__dirname, 'entry-sources.v066.json');
const outputPath = path.join(root, 'publish/main.v066.js');
...
fs.writeFileSync(outputPath, `/* release 0.6.6 sources:${digest} */\n${bundle}\n`);
