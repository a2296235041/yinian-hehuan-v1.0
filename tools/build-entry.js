...
const manifestPath = path.join(__dirname, 'entry-sources.v044.json');
const outputPath = path.join(root, 'publish/main.v044.js');
...
fs.writeFileSync(outputPath, `/* release 0.4.4 sources:${digest} */\n${bundle}\n`);
