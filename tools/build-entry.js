...
const manifestPath = path.join(__dirname, 'entry-sources.v059.json');
const outputPath = path.join(root, 'publish/main.v059.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.9 sources:${digest} */\n${bundle}\n`);
