...
const manifestPath = path.join(__dirname, 'entry-sources.v064.json');
const outputPath = path.join(root, 'publish/main.v064.js');
...
fs.writeFileSync(outputPath, `/* release 0.6.4 sources:${digest} */\n${bundle}\n`);
