...
const manifestPath = path.join(__dirname, 'entry-sources.v054.json');
const outputPath = path.join(root, 'publish/main.v054.js');
...
fs.writeFileSync(outputPath, `/* release 0.5.4 sources:${digest} */\n${bundle}\n`);
