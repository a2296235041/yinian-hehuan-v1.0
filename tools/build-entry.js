...
const manifestPath = path.join(__dirname, 'entry-sources.v049.json');
const outputPath = path.join(root, 'publish/main.v049.js');
...
fs.writeFileSync(outputPath, `/* release 0.4.9 sources:${digest} */\n${bundle}\n`);
