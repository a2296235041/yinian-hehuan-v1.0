...
const manifestPath = path.join(__dirname, 'entry-sources.v065.json');
const outputPath = path.join(root, 'publish/main.v065.js');
...
fs.writeFileSync(outputPath, `/* release 0.6.5 sources:${digest} */\n${bundle}\n`);
