...
const manifestPath = path.join(__dirname, 'entry-sources.v045.json');
const outputPath = path.join(root, 'publish/main.v045.js');
...
fs.writeFileSync(outputPath, `/* release 0.4.5 sources:${digest} */\n${bundle}\n`);
