...
const manifestPath = path.join(__dirname, 'entry-sources.v043.json');
const outputPath = path.join(root, 'publish/main.v043.js');
...
fs.writeFileSync(outputPath, `/* release 0.4.3 sources:${digest} */\n${bundle}\n`);
