...
const manifestPath = path.join(__dirname, 'entry-sources.v060.json');
const outputPath = path.join(root, 'publish/main.v060.js');
...
fs.writeFileSync(outputPath, `/* release 0.6.0 sources:${digest} */\n${bundle}\n`);
